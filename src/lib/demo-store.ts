...
export interface DemoState {
  ...
  jobs: Array<{ id: string; title: string; company: string; location: string; description: string; external_url: string | null; status: JobStatus; fit_score: number; assistant_type: AssistantType; job_profile_id: string | null; created_at: string }>;
  applications: Array<{ id: string; job_id: string; job_profile_id: string | null; resume_id: string | null; assistant_type: AssistantType; status: string; submitted_at: string | null; notes: string | null; answer_evidence: Array<{ label: string; path?: string }> }>;
}
...
function seed(userId: string, email = "alex@example.com"): DemoState {
  return {
    profile: { user_id: userId, full_name: "Alex Kim", email, assistant_type: "human", onboarding_complete: true, assistant_name: "Taylor", whatsapp_url: "https://wa.me/" },
